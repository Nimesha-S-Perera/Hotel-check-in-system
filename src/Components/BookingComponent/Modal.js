...
import {ConvertDate} from "../../Utilities/BookingUtilities/ConvertDate";
import {BookingsDataTable, FetchData} from "./BookingsDataTable";
...
useEffect(() => { 
    ...
    const handleSubmit = async (event) => {
        ...
        if (validateForm() || (checkOutDate < checkInDate)) {
            return
        }
        const data = {
            name: name,
